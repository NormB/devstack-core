"""
Vault integration examples (API-First)
...
Implementation matches code-first approach but generated from OpenAPI specification.
"""

from fastapi import APIRouter, Path
from fastapi_cache.decorator import cache
from app.services.vault import vault_client
from app.models import SecretResponse, SecretKeyResponse
from app.middleware.cache import generate_cache_key

router = APIRouter(prefix="/examples/vault", tags=["Vault Examples"])
