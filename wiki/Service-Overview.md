...
For detailed SSH and GPG setup, see [CONTRIBUTING.md](../Contributing-Guide#setting-up-ssh-and-gpg-keys-for-forgejo).
...
- SSH/GPG setup: [CONTRIBUTING.md](../Contributing-Guide)
