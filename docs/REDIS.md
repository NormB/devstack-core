...
```mermaid
graph TB
    subgraph "Redis Cluster - 16,384 Slots Total"
        subgraph "Node 1 - redis-1"
            R1[Redis Master 1<br/>172.20.2.13<br/><br/>Slots: 0-5460<br/>5,461 slots<br/><br/>Ports:<br/>6379 non-TLS<br/>6390 TLS<br/>16379 cluster bus]
        end

        subgraph "Node 2 - redis-2"
            R2[Redis Master 2<br/>172.20.2.14<br/><br/>Slots: 5461-10922<br/>5,462 slots<br/><br/>Ports:<br/>6380 non-TLS<br/>6391 TLS<br/>16380 cluster bus]
        end

        subgraph "Node 3 - redis-3"
            R3[Redis Master 3<br/>172.20.2.15<br/><br/>Slots: 10923-16383<br/>5,461 slots<br/><br/>Ports:<br/>6381 non-TLS<br/>6392 TLS<br/>16381 cluster bus]
        end
    end

    subgraph "Clients"
        CLIENT[Application Client<br/>redis-cli -c<br/>Python redis-py-cluster<br/>Node.js ioredis]
    end

    subgraph "Data Flow Example"
        KEY1["Key: user:1000<br/>CRC16 Hash → Slot 5139<br/>Routes to Node 1"]
        KEY2["Key: session:2000<br/>CRC16 Hash → Slot 8456<br/>Routes to Node 2"]
        KEY3["Key: cart:3000<br/>CRC16 Hash → Slot 12500<br/>Routes to Node 3"]
    end

    CLIENT -->|Connect to any node| R1
    CLIENT -->|Connect to any node| R2
    CLIENT -->|Connect to any node| R3

    R1 <-.->|Gossip Protocol<br/>Cluster Bus| R2
    R2 <-.->|Gossip Protocol<br/>Cluster Bus| R3
    R3 <-.->|Gossip Protocol<br/>Cluster Bus| R1
    ...
    style R2 fill:#99ccff,stroke:#333,stroke-width:2px
    style R3 fill:#99ff99,stroke:#333,stroke-width:2px
    style CLIENT fill:#ffeb99,stroke:#333,stroke-width:2px
    style KEY1 fill:#ffe6e6,stroke:#333,stroke-width:1px
    style KEY2 fill:#e6f3ff,stroke:#333,stroke-width:1px
    style KEY3 fill:#e6ffe6,stroke:#333,stroke-width:1px
```
